        ...
        <div className="w-full max-w-md bg-[#e8eef1] rounded-[50px] p-5 pt-10 text-center border-2 border-[#e8eef1] shadow-xl">
          ...
          <div className="bg-white rounded-[40px] p-6 sm:p-8 shadow-inner border border-gray-100 text-left">
            ...
            <form className="space-y-6" onSubmit={handleLogin}>
              <div>
                <label className="block text-xl font-bold text-[#1e3d58] mb-2 ml-2">Email Address:</label>
                <input
                  type="email"
                  required
                  value={email}
              ...
              <div className="pt-6 flex justify-center">
                <Button 
                  type="submit" 
                  disabled={isLoading}
                  className="w-2/3 h-14 text-2xl font-bold rounded-full bg-[#43b0f1] text-white border-2 border-[#43b0f1] hover:bg-[#1e3d58] transition-all active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed"
                >
              ...
              <div className="text-center pt-6 pb-2">
                ...
                <Link href="/auth/sign-up" className="text-[#43b0f1] font-bold text-lg hover:underline">
                  Sign up
                </Link>
              </div>
            </form>
