...
export default function ManageAnnouncements() {
  ...
  useEffect(() => {
    const fetchAnnouncement = async () => {
      ...
      //   setExpirationDate(data.expiration_date || ""); // <-- BACKEND: Idagdag ang pag-fetch sa expiration date
      // }
    };
    fetchAnnouncement();
  }, []);
  ...
  const handleSaveAnnouncement = async () => {
    ...
    //   expiration_date: expirationDate ? expirationDate : null  <-- BACKEND: Save as null if empty
    // });
